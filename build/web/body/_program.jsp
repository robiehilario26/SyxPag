                    ...
                    <div class="modal-body">
                        ...
                        <form class="form-horizontal" role="form">
                            <div class="form-group">
                                ...
                                <div class="col-lg-10">
                                    <input type="text" class="form-control" id="programTitle" placeholder="Title">
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="aboutArticle" class="col-lg-2 col-sm-2 control-label">Article</label>
                                <div class="col-lg-10">
                                    <textarea type="text" class="form-control" id="programArticle" placeholder="Article" rows="4"></textarea>
                                </div>
                            </div>
                        </form>
                    </div>
            ...
            <div class="col-lg-12">
                <section class="panel">
                    ...
                    <div class="panel-body">
                        <div class="clearfix">
                            <div class="btn-group">
                                <button class="btn btn-primary" data-target="#myModal-1" onclick="clear_the_form()" data-toggle="modal">
...
<script>
    ...
    function save_edit_about_content() {
        ...
        var article = $('#programArticle').val();
        ...
        $.ajax({
            ...
            url: 'Controller_Program', // Path to file
