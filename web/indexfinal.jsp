        ...
        <nav id="tf-menu" class="navbar navbar-default navbar-fixed-top">
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                    <ul  id ="navigator_hover" class="nav navbar-nav navbar-right">
...
//about-list
                        $.each(response, function (index, value) {
                            ...
                            var about_list_content = '<li>'
                                    ...
                                    + '<strong>' + value.title + '</strong> - <em ><p align="justify"><span class="more">' + value.article + ' </span></p></em>'
                                    + ' </li>';
                    ...
                    <div class="col-md-6">   
                        ...
                        <nav id="thisthisocial">
                            <div class="pull-right fnav">
                                <ul class="social-social_icon hover01">


                                    <li><a href="#"> <figure>  <img class="fa fa-dribbble" src="img/icon/alahzar-university.png" alt="Mountain View" style="width:80px;height:80px;"> </figure></a></li>
                                    <li><a href="#">  <figure>  <img class="fa fa-dribbble" src="img/icon/imamcouncil2.png" alt="Mountain View"> </figure></a></li>
                                    <li><a href="#"> <figure>   <img class="fa fa-dribbble" src="img/icon/jiamat2.png" alt="Mountain View" style="width:80px;height:80px;"> </figure></a></li>
                                    <li><a href="#"> <figure>   <img class="fa fa-dribbble" src="img/icon/rotary.png" alt="Mountain View" style="width:80px;height:80px;"></figure></a></li>
                    ...
                    success: function (response) {
                        $.each(response, function (index, value) {
                            ...
                            var about_list_team = '<div class="owl-item" style="width: 285px;">'
                                    ...
                                    + ' <figure><img src="Picture_view?id=' + id_pic + '&set_table=' + table_name + '" alt = "User Image"  class="img-circle team-img" /></figure>'
                                    + '  <div class="caption">'
                                    + '  <h3>' + value.title + '</h3>'
                                    + '   <p>' + value.article + ' </p>'
                                    + '  </div>'
        ...
        <div id="tf-blog">
            <div class="container"> <!-- Container -->
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="categories the_links">
...
//                        $("#basher_blog_content").remove();
                    ...
                    success: function (response) {
                        ...
                        $.each(response, function (index, value) {
                            ...
                            text = text + '<p><span class="more">' + value.desc + '</span></p>';
        ...
        <div id="tf-clients" class="text-center">
            <div class="overlay">
                <div class="container">
                    ...
                    <div class="space"></div>
                    <div class="row"> 
                        <div class="col-md-8 hover01" id="ul_content_data_activity_data">
                ...
                <div class="row">
                    <div class="col-md-8 col-md-offset-2">
                        ...
                        <script>
                            ...
                            function sending_email_function() {


                                var name = $("#input_name").val();
                                var email = $("#input_email").val();
                                var details = $("#input_details").val();
...
//                                $('#error_email').show();
                                ...
                                $.ajax({
                                    ...
                                    url: 'SendingEmailUsingGmail', // Path to file
                        ...
                        <form>
                            <div class="row">
                                ...
                                <div class="col-md-12" id="loading_email" style="display:none">
                                    <div class="form-group">
                                        <span style="color:blue">Please wait...... sending email </span>
                                    </div>
                                </div>

                                <div class="col-md-12"  id="sent_email" style="display:none">
                                    <div class="form-group">
                                        <span style="color:green">Successfully Sent </span>
                                    </div>
                                </div>

                                <div class="col-md-12"  id="error_email" style="display:none">
                                    <div class="form-group">
                                        <span style="color:red">An error Occured Try Again </span>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="email" class="form-control" id="input_name" placeholder="Your name">
                                    </div>
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control" rows="3" id="input_details"></textarea>
                            </div>

                            <button type="button" onclick="sending_email_function()" class="btn tf-btn btn-default">Submit</button>
                        </form>
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        ...
                        $.each(response, function (index, value) {
                            ...
                            var blog_title = '<li>'
                                    + ' <span  class="fa fa-angle-double-right" ></span>'
                                    + '  <span  id="list' + counting + '"   onclick="clcik_me(this)">  <a href="#tf-blog"  class="effect-underline">' + value.title + '</a></span>'
                                    + '</li>';
                    ...
                    success: function (response) {
                        ...
                        $.each(response, function (index, value) {
                            ...
                            var about_list_acknowledgment = '<li>'
                                    ...
                                    + '<strong style="color:white">' + value.file_name + ' </strong>'
                                    + '  </a> </li>';
...
//                $('#example1').DataTable().clear().draw();
                ...
                text = text + '<li><a href="#" data-filter="*" class="active"><span style="color:white">All </span></a></li>';
                $.each(response, function (index, value) {
                    var str = value.date_only_string;
                    var split = str.split("-");
                    var set_month_name = parseFloat(split[0]) - parseFloat("1");
                    ...
                    text = text + '<li><a href="#" data-filter=".' + get_month_name + '" class="active"> <span style="color:white">' + get_month_name + '</span></a></li>';
