    ...
    var p = function(d) {
        var j = function(a, b) {
            ...
            if (this instanceof j) {
                ...
                this.dom = {scroller: null, header: null, body: null, footer: null, grid: {wrapper: null, dt: null, left: {wrapper: null, head: null, body: null, foot: null}, right: {wrapper: null,
                            head: null, body: null, foot: null}}, clone: {left: {header: null, body: null, footer: null}, right: {header: null, body: null, footer: null}}};
        ...
        j.prototype = {fnUpdate: function() {
                ...
                if ("function" != typeof this.s.dt.oInstance.fnVersionCheck ||
                    ...
                    alert("FixedColumns " + j.VERSION + " required DataTables 1.8.0 or later. Please upgrade your DataTables installation");
                ...
                for (var c = [], g = [], f = [], e = 0, h = a.length; e < h; e++) {
                    ...
                    for (var k = 0, j = this.s.iTableColumns; k < j; k++)
                        if (-1 !== d.inArray(k, b)) {
                            var m = d.inArray(a[e][k].cell, f);
                            -1 === m ? (m = d(a[e][k].cell).clone(!0, !0)[0], g.push(m), f.push(a[e][k].cell), i.push({cell: m, unique: a[e][k].unique})) : i.push({cell: g[m], unique: a[e][k].unique})
                        }
                    c.push(i)
                }
                return c
                ...
                if (g) {
                    ...
                    for (h = n.length; e < h; e++) {
                        i = 0;
                        for (k = n[e].length; i < k; i++)
                            q[e][i].cell.className = n[e][i].cell.className, d("span.DataTables_sort_icon", q[e][i].cell).each(function() {
                ...
                if (0 < l.aiDisplay.length) {
                    ...
                    for (o = 0; o < c.length; o++)
                        j = c[o], m = d(l.aoColumns[j].nTh).clone(!0)[0], m.innerHTML = "", k = m.style, k.paddingTop = "0", k.paddingBottom = "0", k.borderTopWidth = "0", k.borderBottomWidth = "0", k.height = 0, k.width = f.s.aiInnerWidths[j] + "px", h.appendChild(m);
                ...
                if (null !== l.nTFoot) {
                    if (g) {
                        ...
                        for (h = n.length; e < h; e++) {
                            i = 0;
                            for (k = n[e].length; i < k; i++)
                                b[e][i].cell.className = n[e][i].cell.className
                        }
                    }
