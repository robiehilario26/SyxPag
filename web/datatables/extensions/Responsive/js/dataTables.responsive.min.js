...
(function(n, p) {
    var o = function(e, k) {
        ...
        h.prototype = {_constructor: function() {
                ...
                for (g = f.length; b < g; b++)
                    !0 === f[b] && (i += c[b].minWidth);
                b = a.settings()[0].oScroll;
                b = b.sY || b.sX ? b.iBarWidth : 0;
                a = a.table().container().offsetWidth - b - i;
                b = 0;
                for (g = f.length; b < g; b++)
                    c[b].control && (a -= c[b].minWidth);
                i = !1;
                b = 0;
                for (g = f.length; b < g; b++)
                    "-" === f[b] && !c[b].control && (i || 0 > a - c[b].minWidth ? (i = !0, f[b] = !1) : f[b] = !0, a -= c[b].minWidth);
                a = !1;
                b = 0;
                ...
                var d = this, a = this.c.breakpoints, c = this.s.dt.columns().eq(0).map(function(a) {
                    ...
                    return{className: a, includeIn: [], auto: !1, control: !1, never: a.match(/\bnever\b/) ?
                                !0 : !1}
                }), b = function(a, b) {
                    var d = c[a].includeIn;
        ...
        h.defaults = {breakpoints: h.breakpoints,
            auto: !0, details: {renderer: function(d, a) {
