 ...
 * @author user
 */
@WebServlet(name = "BlogFirstView", urlPatterns = {"/BlogFirstView"})
public class BlogFirstView extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            about = (ArrayList<BasherModel>) dao.getDetailsForBlogForVideoFirst();
            Gson gson = new Gson();
