 ...
 * @author User
 */
@WebServlet(name = "Data_table_gallery", urlPatterns = {"/Data_table_gallery"})
public class Data_table_gallery extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            about = (ArrayList<BasherModel>) dao.getDetailsForGallery();
            Gson gson = new Gson();
