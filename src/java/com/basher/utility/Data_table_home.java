 ...
 * @author User
 */
@WebServlet(name = "Data_table_home", urlPatterns = {"/Data_table_home"})
public class Data_table_home extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            about = (ArrayList<BasherModel>) dao.getDetailsForHome();
            Gson gson = new Gson();
