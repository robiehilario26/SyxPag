 ...
 * @author User
 */
@WebServlet(name = "Data_table_pricing_maintenance", urlPatterns = {"/Data_table_pricing_maintenance"})
public class Data_table_pricing_maintenance extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
       ...
       try {
            ...
            about = (ArrayList<SalesOrderModel>) dao.getDetailspricing_maintenance();
            Gson gson = new Gson();
