 ...
 * @author User
 */
@WebServlet(name = "Dropdown_list_pricing", urlPatterns = {"/Dropdown_list_pricing"})
public class Dropdown_list_pricing extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
         ...
         try {
            ...
            unit = (ArrayList<SalesOrderModel>) dao.getClientData();
            Gson gson = new Gson();
