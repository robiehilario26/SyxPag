 ...
 * @author User
 */
@WebServlet(name = "Data_table_PO", urlPatterns = {"/Data_table_PO"})
public class Data_table_PO extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
      ...
      try {
            ...
            about = (ArrayList<SalesOrderModel>) dao.getDetails_PO();
            Gson gson = new Gson();
