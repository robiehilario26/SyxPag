 ...
 * @author User
 */
@WebServlet(name = "Dropdown_list_PO", urlPatterns = {"/Dropdown_list_PO"})
public class Dropdown_list_PO extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            unit = (ArrayList<SalesOrderModel>) dao.getPOData();
            Gson gson = new Gson();
