 ...
 * @author User
 */
@WebServlet(name = "Data_table_pricing_maintenance_vendor", urlPatterns = {"/Data_table_pricing_maintenance_vendor"})
public class Data_table_pricing_maintenance_vendor extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
         ...
         try {
            ...
            about = (ArrayList<SalesOrderModel>) dao.getDetailspricing_maintenance_vendor();
            Gson gson = new Gson();
