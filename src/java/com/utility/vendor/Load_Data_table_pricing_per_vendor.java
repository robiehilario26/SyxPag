 ...
 * @author User
 */
@WebServlet(name = "Load_Data_table_pricing_per_vendor", urlPatterns = {"/Load_Data_table_pricing_per_vendor"})
public class Load_Data_table_pricing_per_vendor extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            about = (ArrayList<SalesOrderModel>) dao.getDetailspricing_per_vendor(get_pk);
            Gson gson = new Gson();
