 ...
 * @author User
 */
@WebServlet(name = "Data_table_SO_per_customer", urlPatterns = {"/Data_table_SO_per_customer"})
public class Data_table_SO_per_customer extends HttpServlet {
...
//        String get_pk = "1";
        ...
        try {
            ...
            about = (ArrayList<SalesOrderModel>) dao.getDetailspricing_per_customer_SO(get_pk);
            Gson gson = new Gson();
