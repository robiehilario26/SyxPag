 ...
 * @author User
 */
@WebServlet(name = "Data_table_SO", urlPatterns = {"/Data_table_SO"})
public class Data_table_SO extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
         ...
         try {
            ...
            about = (ArrayList<SalesOrderModel>) dao.getDetails_SO();
            Gson gson = new Gson();
