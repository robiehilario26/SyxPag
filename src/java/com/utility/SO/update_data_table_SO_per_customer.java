 ...
 * @author User
 */
@WebServlet(name = "update_data_table_SO_per_customer", urlPatterns = {"/update_data_table_SO_per_customer"})
public class update_data_table_SO_per_customer extends HttpServlet {
...
//        String get_pk = "00025";
        ...
        try {
            ...
            about = (ArrayList<SalesOrderModel>) dao.update_SO_per_customer(get_pk);
            Gson gson = new Gson();
