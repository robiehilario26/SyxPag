 ...
 * @author User
 */
@WebServlet(name = "Dropdown_list_store", urlPatterns = {"/Dropdown_list_store"})
public class Dropdown_list_store extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
       ...
       try {
            ...
            unit = (ArrayList<SalesOrderModel>) dao.get_storenames();
            Gson gson = new Gson();
