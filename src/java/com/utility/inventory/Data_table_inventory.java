 ...
 * @author User
 */
@WebServlet(name = "Data_table_inventory", urlPatterns = {"/Data_table_inventory"})
public class Data_table_inventory extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
       ...
       try {
            ...
            about = (ArrayList<SalesOrderModel>) dao.getInventory();
            Gson gson = new Gson();
