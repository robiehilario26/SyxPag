 ...
 * @author User
 */
//@WebServlet(name = "Data_table_product_maintenance", urlPatterns = {"/newtest"})
public class Data_table_product_maintenance extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
       ...
       try {
            ...
            about = (ArrayList<SalesOrderModel>) dao.getDetailsproduct_maintenance();
            Gson gson = new Gson();
